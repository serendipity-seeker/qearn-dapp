...
const InfoBanner: React.FC = () => {
  ...
  return (
    <div className="w-full p-6 flex md:flex-row flex-col justify-center items-center gap-6 border-t-2 border-b-2 border-gray-50 border-opacity-20">
      <div>
        <span>
      ...
      <div className="text-center px-4 md:border-l-2 md:border-r-2 md:border-gray-50 border-opacity-20">
